...
async def rabbitmq_consumer(app: FastAPI):
    asyncio.create_task(consume_queue(name_queue='create_event_queque', func=create_event))
    asyncio.create_task(consume_queue(name_queue='update_event_queque', func=update_event))
    yield
